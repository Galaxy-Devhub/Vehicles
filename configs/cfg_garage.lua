...
-----------------MET POLICE AND NHS
  ...
  ["MET Vehicles"] = {
	...
	["polm2"] = {"Hyperceptor BMW M2",0, ""},
	["pdbmw540i"] = {"Police BMW 540I",0, ""},
	["pdjagxfr"] = {"Police Jaguar XFR",0, ""},
	["pdtran"] = {"Police Transit Van",0, ""},
	["pdvolvomarked"] = {"Police Volvo Marked",0, ""},
...
cfg.locksandimports = {
	["Locks"] = {
		...
		["evo10"] = {"Mitisibushi EVO X",999999999999, ""},
	...
	["Custom Import"] = { -- ALL CUSTOM IMPORTS ARE TO BE NORMAL CAR NAMES
		...
		["brickaderv"] = {"Brickade RV",999999999999, ""},
		["unimog"] = {"Unimong",999999999999, ""},
		["huracandyredxxb"] = {"Huracan XXB",999999999999, ""},
...
cfg.garages = {
	...
	{"Car", -964.27, -3025.8, 23.95},
	{"Car", 2492.75, -447.23, 93},
	{"Car", 902.23, -53.57, 78.76},
	{"Car", 417.86, -645.43, 28.5},
	{"Car", -617.59, -1035.94, 21.94},
	{"Car", -1724.59, -1122.74, 13.1},
	{"Car", 356.93, -16.2, 83},
}
cfg.dealers = {
